...
Usage:
    python -m ttfm.runners.backtest_multiday ES 15
    python -m ttfm.runners.backtest_multiday NQ 30
    python -m ttfm.runners.backtest_multiday ES 15 --t1-r=3 --trail-r=6
"""
import sys
sys.path.insert(0, '.')
...
from ttfm.runners.run_ttfm import run_session_ttfm, SYMBOL_CONFIG
