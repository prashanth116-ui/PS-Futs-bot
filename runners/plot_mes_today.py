"""
Plot today's MES trade with 3 contracts and 4R/8R targets.
"""
import sys
sys.path.insert(0, '.')
...
def plot_mes_today():
    ...
    ax.set_title(f'MES 3-Minute | Jan 27, 2026 | LONG Trade | 3 Contracts | 4R/8R Targets\n'
                 f'Total P/L: +$143.12 | Risk: {risk:.2f} pts ({risk/tick_size:.0f} ticks) | Tick Value: $1.25',
                 fontsize=14, fontweight='bold')
    ax.legend(loc='upper left', fontsize=10)
    ax.grid(True, alpha=0.3)

    # Add summary box
    summary = (f'MES TRADE SUMMARY\n'
    ...
    plt.tight_layout()
    plt.savefig('backtest_MES_today_2026-01-27.png', dpi=150, bbox_inches='tight')
    print('Saved: backtest_MES_today_2026-01-27.png')
    plt.close()
